# _base_ = './configs/detectors/detectors_htc_r50_1x_coco.py'
_base_ = './configs/htc/htc_without_semantic_r50_fpn_1x_coco.py'
...
# pretrained
# load_from = './checkpoints/detectors_htc_r50_1x_coco-329b1453_v1.pth'

# If stop accidentally
load_from = './work_dirs/config_detectoRS/latest.pth'
resume_from = './work_dirs/config_detectoRS/latest.pth'

work_dir = './work_dirs/config_detectoRS'
